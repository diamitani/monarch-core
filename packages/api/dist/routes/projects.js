...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            success: false,
            error: { code: 'LIST_PROJECTS_ERROR', message: error.message }
        });
    }
});
/**
...
router.patch('/:projectId', async (req, res) => {
    ...
    try {
        ...
        logger.error('Update project failed', error, { projectId });
        res.status(500).json({
            success: false,
...
router.delete('/:projectId', async (req, res) => {
    ...
    try {
        ...
        logger.error('Delete project failed', error, { projectId });
        res.status(500).json({
            success: false,
